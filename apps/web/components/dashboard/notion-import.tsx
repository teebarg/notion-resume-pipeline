    ...
    const loadSampleData = () => {
        const sampleData: ResumeData = {
            basics: {
                ...
                summary:
                    "Passionate full-stack developer with 6+ years of experience building scalable web applications. Expertise in React, Node.js, and cloud infrastructure. Led teams to deliver products used by millions of users.",
            },
            experience: [
                {
            ...
            <DialogContent className="sm:max-w-md">
                ...
                <div className="space-y-4 py-4">
                    ...
                    <div className="flex flex-col gap-2">
                        <Button onClick={handleImport} disabled={!pageUrl || status === "loading"} className="w-full">
                            {status === "loading" ? (
                                <>
                        ...
                        <Button variant="secondary" onClick={loadSampleData} disabled={status === "loading"} className="w-full">
                            Load Sample Resume
                        </Button>
                    </div>
